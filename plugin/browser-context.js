/**
 * OpenCode Browser Context Plugin (Standalone)
 * 
 ...
 * 
 * USAGE:
 * Copy this file to ~/.config/opencode/plugin/ or use it as part of the
 * opencode-browser-agent package.
 * 
 * This is a standalone version that doesn't require the MCP server.
 * For full browser automation, use the opencode-browser-agent package.
 */
